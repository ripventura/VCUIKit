...
private class CustomHUD: UIView {
    ...
    func setup(message : String) {
        ...
        self.backgroundColor = sharedAppearanceManager.hudBackgroundColor
        self.tintColor = sharedAppearanceManager.hudTintColor
        
        let spinner = SWActivityIndicatorView(frame: CGRectDefault)
        spinner.lineWidth = 3
        spinner.autoStartAnimating = true
        spinner.hidesWhenStopped = false
        spinner.color = sharedAppearanceManager.hudTintColor
        ...
        messageLabel?.textColor = sharedAppearanceManager.hudMessageColor
