...
open class VCBannerCreator {
    ...
    public func showBannerWithTheme(theme : Theme,
        ...
        if theme == .success {
            //view.configureTheme(backgroundColor: sharedStyleManager.bannerSuccessBackgroundColor, foregroundColor: UIColor.whiteColor())
            view.configureContent(title: title != nil ? title! : "Success", body: message)
        }
        else if theme == .error {
            //view.configureTheme(backgroundColor: sharedStyleManager.bannerErrorBackgroundColor, foregroundColor: UIColor.whiteColor())
            view.configureContent(title: title != nil ? title! : "Error", body: message)
        }
        else if theme == .info {
            //view.configureTheme(backgroundColor: sharedStyleManager.bannerInfoBackgroundColor, foregroundColor: UIColor.whiteColor())
    ...
    public func showStatusBarMessage(theme : Theme? = nil,
        ...
        // Specify a status bar style to if the message is displayed directly under the status bar.
        config.preferredStatusBarStyle = sharedStyleManager.applicationStatusBarStyle
        ...
        if theme == nil {
            view.backgroundView.backgroundColor = sharedStyleManager.navigationBarBackgroundColor
            view.bodyLabel?.textColor = sharedStyleManager.navigationBarTintColor
        } else {
            // Theme message elements with the desired style.
            view.configureTheme(theme!)
        }
